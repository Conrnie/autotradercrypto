"""
AI Trading System
Volume Profile Mean Reversion Trading met DeepSeek AI Bevestiging
"""
...
ACTIVE_AGENTS = {
    ...
    'position_monitor': True,  # Position monitoring agent
...
def print_banner():
    ...
    cprint("\n" + "="*100, "cyan")
    cprint(" ", "cyan")
    cprint("🤖 AI TRADING SYSTEEM".center(100), "white", "on_cyan", attrs=['bold'])
    cprint(" ", "cyan")
    cprint("="*100, "cyan")
...
def run_agents():
    ...
    try:
        ...
        position_manager = PositionManager() if ACTIVE_AGENTS['position_monitor'] else None
        ...
        while True:
            try:
                ...
                # ========================================
                # STEP 2: Position Monitoring & Management
                # ========================================
                if position_manager:
                    cprint("\n👁️  STEP 2: POSITION MONITORING & MANAGEMENT", "cyan", attrs=['bold'])
                    cprint("─"*100 + "\n", "cyan")

                    try:
                        monitoring_result = position_manager.run()
                        cprint(f"\n✅ Position monitoring complete", "green")
                    except Exception as e:
                        cprint(f"\n⚠️  Error in position monitoring: {e}", "yellow")
                        cprint("   Continuing to next step...\n", "yellow")

                # ========================================
                # STEP 3: Liquidation Context Analysis
                # ========================================
                liquidation_context = None

                if liquidation_agent:
                    cprint("\n📊 STEP 3: LIQUIDATION CONTEXT ANALYSIS", "cyan", attrs=['bold'])
                    cprint("─"*100 + "\n", "cyan")
                ...
                if strategy_agent:
                    cprint("\n🎯 STEP 4: VOLUME PROFILE SIGNAL GENERATION", "cyan", attrs=['bold'])
                    cprint("─"*100 + "\n", "cyan")
                ...
                # ========================================
                # STEP 5: AI Confirmation & Execution
                # ========================================
                if trading_agent and signals:
                    cprint("\n🤖 STEP 5: DEEPSEEK AI CONFIRMATION & EXECUTION", "cyan", attrs=['bold'])
                    cprint("─"*100 + "\n", "cyan")
        ...
        cprint("="*100, "yellow")
        cprint("\n✅ Bedankt voor het gebruiken van het AI Trading Systeem!\n", "cyan")
